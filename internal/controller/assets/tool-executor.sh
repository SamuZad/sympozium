...
#
# It is embedded in the Sympozium controller and mounted into every skill
# sidecar via the "sympozium-tool-executor" ConfigMap, so any container
# image with bash, jq, and coreutils can serve as a skill sidecar.
