...
func (in *AgentConfigMemory) DeepCopyInto(out *AgentConfigMemory) {
	*out = *in
	...
	if in.SeedTTLDays != nil {
		in, out := &in.SeedTTLDays, &out.SeedTTLDays
		*out = new(int)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EnsembleTargetSelector) DeepCopyInto(out *EnsembleTargetSelector) {
	*out = *in
	...
	if in.EnsembleSelector != nil {
		in, out := &in.EnsembleSelector, &out.EnsembleSelector
		*out = new(metav1.LabelSelector)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EnsembleTargetSelector.
func (in *EnsembleTargetSelector) DeepCopy() *EnsembleTargetSelector {
	if in == nil {
		return nil
	}
	out := new(EnsembleTargetSelector)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MembraneExportRule) DeepCopyInto(out *MembraneExportRule) {
	*out = *in
	if in.Visibilities != nil {
		in, out := &in.Visibilities, &out.Visibilities
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.Tags != nil {
	...
	in.ToEnsembles.DeepCopyInto(&out.ToEnsembles)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MembraneExportRule.
func (in *MembraneExportRule) DeepCopy() *MembraneExportRule {
	if in == nil {
		return nil
	}
	out := new(MembraneExportRule)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MembraneImportRule) DeepCopyInto(out *MembraneImportRule) {
	*out = *in
	if in.Tags != nil {
		in, out := &in.Tags, &out.Tags
		*out = make([]string, len(*in))
	...
	in.FromEnsembles.DeepCopyInto(&out.FromEnsembles)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MembraneImportRule.
func (in *MembraneImportRule) DeepCopy() *MembraneImportRule {
	if in == nil {
		return nil
	}
	out := new(MembraneImportRule)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MembraneSpec) DeepCopyInto(out *MembraneSpec) {
	*out = *in
	...
	if in.Export != nil {
		...
		*out = make([]MembraneExportRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.Import != nil {
		...
		*out = make([]MembraneImportRule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
